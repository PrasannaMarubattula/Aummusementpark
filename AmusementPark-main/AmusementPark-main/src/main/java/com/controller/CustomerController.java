...
public class CustomerController {
   ...
   @GetMapping(path="/viewCustomer/{customerid}")
	...
	public ResponseEntity<List<Customer>> viewCustomeListByActivity(@PathVariable String activityName) 
	{
	...
	public ResponseEntity<List<Customer>> viewCustomeListByDate(@PathVariable LocalDate date) 
	{
